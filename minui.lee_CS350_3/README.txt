...
a. How to use parts of your user interface that is NOT specified in the assignment description. 
	...
	Drag mouse curser while holding the mouse right button to rorate the camera
...
c. Which part of the assignment has been completed?
	I beilieve all the parts that are required have been completed except ones that are mentioned in question d.
...
explanation on why those parts are not completed?
	BSP tree serialization
	Octree with different colors for each section
