...
public:
	...
	const unsigned getNrOfVertices() { return  static_cast<const unsigned>(vertices.size()); }
	const unsigned getNrOfIndices() { return static_cast<const unsigned>(indices.size()); }
...
public:
		...
		: Primitive()
	{
		Vertex vertices_[] =
		{
			...
			glm::vec3(-1.f, 1.f, 0.f),			glm::vec3(1.f, 0.f, 0.f),		glm::vec2(0.f, 1.f),		glm::vec3(0.f, 0.f, 1.f),
			glm::vec3(-1.f, -1.f, 0.f),			glm::vec3(0.f, 1.f, 0.f),		glm::vec2(0.f, 0.f),		glm::vec3(0.f, 0.f, 1.f),
			glm::vec3(1.f, 1.f, 0.f),			glm::vec3(0.f, 0.f, 1.f),		glm::vec2(1.f, 1.f),		glm::vec3(0.f, 0.f, 1.f),
			glm::vec3(1.f, -1.f, 0.f),			glm::vec3(1.f, 1.f, 0.f),		glm::vec2(1.f, 0.f),		glm::vec3(0.f, 0.f, 1.f)
		};
		unsigned nrOfVertices = sizeof(vertices_) / sizeof(Vertex);

		set(vertices_, nrOfVertices, nullptr, 0);
	}
};
