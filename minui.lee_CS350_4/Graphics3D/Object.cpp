...
Object::Object(glm::vec3 position_, Material* material_, std::vector<Light*> lights_, Texture* orTexDif, Texture* orTexSpec)
{
	position = position_;
	origin = glm::vec3(0.f);
...
void Object::Render(Shader* shader, Mesh* mesh, GLenum mode)
{
	...
	material->sendDiffSpecToShader(*shader);
...
void Object::RenderNormal(Shader* shader, Mesh* mesh)
{
	...
	shader->SetVec3f(glm::vec3(0.1, 0.5, 0), "line_color");
...
void Object::RenderFaceNormal(Shader* shader, Mesh* mesh)
{
	...
	shader->SetVec3f(glm::vec3(0.4, 0.35, 1), "line_color");
	
	shader->Use();
	mesh->RenderFaceNormal(shader);
}

void Object::RenderObjectInNDC(Shader* shader, Mesh* mesh, GLenum mode)
{
	shader->Use();
